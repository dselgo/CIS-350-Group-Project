...
public class Twitter4JGUI extends javax.swing.JFrame {
    ...
    private void addDeleteButtonListener(ActionListener a){
    	deleteButton.addActionListener(a);
    }
    
    private void addRetweetButtonListener(ActionListener a){
    	retweetButton.addActionListener(a);
    }
    
    private void addFollowButtonListener(ActionListener a){
    	followButton.addActionListener(a);
    }
    
    private void addTimelineButtonListener(ActionListener a){
    	timelineButton.addActionListener(a);
    }
    
    private void addCloseButtonListener(ActionListener a){
    	closeButton.addActionListener(a);
    }
    
    private void addUpdateButtonListener(ActionListener a){
    	updateButton.addActionListener(a);
    }
    
    private void addSwitchAccountButtonListener(ActionListener a){
    	switchAccountButton.addActionListener(a);
    }

    private void addSwitchAccountDialogButtonListener(ActionListener a){
    	switchAccountDialogButton.addActionListener(a);
    }
    
    private void addSearchTopicsButtonListener(ActionListener a){
    	searchTopicsButton.addActionListener(a);
    }
    

    private void addSearchPeopleButtonListener(ActionListener a){
    	searchPeopleButton.addActionListener(a);
    }
    
    private void addSearchTopicTextFieldListener(ActionListener a){
    	searchTopicTextField.addActionListener(a);
    }
    
    private void addSearchPeopleTextFieldListener(ActionListener a){
    	searchPeopleTextField.addActionListener(a);
    }
    
    private void addRefreshMenuItemListener(ActionListener a){
    	refreshMenuItem.addActionListener(a);
    }
    
    private void addGetHelpMenuItemListener(ActionListener a){
    	getHelpMenuItem.addActionListener(a);
    }
    
    private void addQuitMenuItemListener(ActionListener a){
    	quitMenuItem.addActionListener(a);
    }
    ...
    private void tweetTableMouseClicked(
        ...
        try {
            ...
            if (index != -1) {
                displayTweetText.setText(engine.getTable().get(index).getText());
            }
        } catch (Exception ex) {
            displayError(ex);
        }
